        ...
        <div className="container">
          <header className="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <NavLink to="/" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-decoration-none">
              <span className="fs-4" style={{ color: 'red' }}><strong>319Feed</strong></span>
            </NavLink>
    ...
    return (
      <footer className="text-body-secondary py-5 mt-auto">
        <div className="container">
          ...
          <p className="mb-0">Learn more about us <NavLink to="/about">here</NavLink>.</p>
        </div>
      </footer>
    );
  };
  ...
  const QuizList = () => {
    ...
    return (
      <div className="container mt-3">
        ...
        {quizzes.map((quiz) => (
          <div key={quiz.quizId} className="card my-3 shadow">
            <img src={quiz.url} className="card-img-top" alt="Quiz Cover" />
            <div className="card-body">
              <h5 className="card-title">{quiz.title}</h5>
              <p className="card-text">{quiz.descript}</p>
              <Link to={`/quizzes/${quiz.quizId}`} className="btn btn-primary">Take this Quiz</Link>
            </div>
          </div>
        ))}
      </div>
          ...
          <main className="about-body">
            ...
            <div className="team-container">
              <div className="team-member left">
                ...
                <p><a href="mailto:muralip@iastate.edu">muralip@iastate.edu</a></p>
              </div>

              <div className="team-member right">
                <h2>Gabriel Unser</h2>
                <p style={{ fontStyle: "italic", color: "grey" }}>Computer Science</p>
                <p><a href="mailto:gunser@iastate.edu">gunser@iastate.edu</a></p>
              </div>
            </div>
